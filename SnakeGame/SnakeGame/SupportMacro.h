...
#define cwksc_merge_body(a, b) a ## b
#define cwksc_merge(a, b) cwksc_merge_body(a, b)
#define uniqueVarName(name) cwksc_merge(name, __COUNTER__)
#define uniqueVarName2(name) cwksc_merge_body leftBracket name, __COUNTER__ )
